  ...
  public static function lgp_generate_league_selecbox(){
    ...
    <div class="form-check d-block my-3">
        <div class="col-md-12 my-3">
            <select class="custom-select" id="sport_league" name="sport_league" aria-label="Example select with button addon">
  ...
  ?>
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-3">
        ...
        <input class="form-control" type="number" min="1" max="90" name="time2" id="time2" value="90" required="required">
  ...
  ?>
    ...
    <div class="row">
      <div class="col-md-6 mb-3">
        ...
        <input type="number" class="form-control" min="0" name="host_tally" id="host_tally" value="0" placeholder="" required disabled>
      ...
      <div class="col-md-6 mb-3">
        ...
        <input type="number" class="form-control" min="0" name="guest_tally" id="guest_tally" value="0" placeholder="" required disabled>
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-3">
        <div class="col-md-6" id="marketValue">
          <input class="form-control" type="number" min="0.5" max="19.5" value="0.5" step="1" name="market_value" id="market_value">
        </div>
      </div>
    </div>
    <!-- markets end-->
  ...
  public static function lgp_generate_handycap_inputs(){
    ...
    <div class="row">
      <div class="col-md-6 mb-3">
        ...
        <input type="number" class="form-control" min="-3.5" max="3.5" name="host_handicap" id="host_handicap" value="0" placeholder="" required disabled>
      </div>
      <div class="col-md-6 mb-3">
        <div class="form-check d-block col-md-6 my-3">
        ...
        <input type="number" class="form-control" min="-3.5" max="3.5" name="guest_handicap" id="guest_handicap" value="0" placeholder="" required disabled>
      </div>
    </div>
    <hr class="mb-4">
    <!-- handycap end-->
  ...
  public static function lgp_generate_total_inputs(){
    ...
    <div class="row">
      ...
      <div class="col-md-6" id="totalDiv">
        <input class="form-control" type="number" min="0.5" max="19.5" value="0.5" step="1" name="total" id="total" value="0.5">
  ...
  ?>
    ...
    <div class="col-md-4 order-md-1 mb-4">
      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Параметры</a>
        <a class="nav-link" id="v-pills-result-tab" data-toggle="pill" href="#v-pills-result" role="tab" aria-controls="v-pills-result" aria-selected="false">Результат</a>
        <a class="nav-link" id="v-pills-totalb-tab" data-toggle="pill" href="#v-pills-totalb" role="tab" aria-controls="v-pills-totalb" aria-selected="false">Тотал Больше</a>
        <a class="nav-link" id="v-pills-totalm-tab" data-toggle="pill" href="#v-pills-totalm" role="tab" aria-controls="v-pills-totalm" aria-selected="false">Тотал Меньше</a>
        <a class="nav-link" id="v-pills-forab-tab" data-toggle="pill" href="#v-pills-forab" role="tab" aria-controls="v-pills-forab" aria-selected="false">Фора Больше</a>
        <a class="nav-link" id="v-pills-foram-tab" data-toggle="pill" href="#v-pills-foram" role="tab" aria-controls="v-pills-foram" aria-selected="false">Фора Меньше</a>
      </div>
    </div>
  <?php
  }
          ...
          <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
              ...
              <form method="post" id="lgpFilterForm" class="needs-validation" novalidate>
                  ...
                  <input type="submit" class="btn btn-primary btn-lg btn-block" id="lgp-filter-form-btn" value="Рассчитать">
                </form>
              <!-- form END -->
            </div>
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                  ...
                  <div class="progress tb">
                    <div id="progress-tb" class="progress-bar bg-success" role="progressbar" style="width: 0%;" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </li>
                <li class="list-group-item">
                  Вероятность ТМ <span id="tm_r"></span>
                  <div class="progress tm">
                    <div id="progress-tm" class="progress-bar bg-warning" role="progressbar" style="width: 0%;" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div class="tab-pane fade" id="v-pills-totalb" role="tabpanel" aria-labelledby="v-pills-totalb-tab">
              ...
              <div class="table-responsive">
                <table class="table" id="lgp_tb">
                  <caption>Голы в матчах с тоталом меньше</caption>
                  <thead>
                    <tr>
                      <th scope="col">#</th>
            ...
            <div class="tab-pane fade" id="v-pills-forab" role="tabpanel" aria-labelledby="v-pills-forab-tab">

            </div>
            <div class="tab-pane fade" id="v-pills-foram" role="tabpanel" aria-labelledby="v-pills-foram-tab">
